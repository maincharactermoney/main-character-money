  ...
  return (
    <main className="episodes-page">
      ...
      <section className="episodes-list">
        {episodes.map((ep) => (
          <div key={ep.id} className="episode-card-wrapper">
            <Link href={`/episodes/${ep.slug}`} className="episode-card">
            ...
            <div className="episode-stream-buttons">
              {ep.spotifyUrl && (
                <a
                  href={ep.spotifyUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="stream-btn stream-btn--spotify"
                >
              ...
              {ep.appleUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="stream-btn stream-btn--apple"
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
              ...
              {ep.youtubeUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="stream-btn stream-btn--youtube"
                >
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
